...
* [dnsServer](listeners/dns_server.md) – Plain DNS (UDP/TCP) listener that terminates queries on a socket. It does **not** speak DoT/DoH; use upstream DoT/DoH resolvers if you need encrypted transport.
